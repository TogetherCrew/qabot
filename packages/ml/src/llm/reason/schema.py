class JsonSchema:
    schema = {
        ...
        "thoughts": {
            ...
            "reasoning": "Reasoning about the action to complete the task based on information in knowledge and past_events and using one of the tools in [TOOLS]. If the task can be completed, always use the task_complete tool to provide an answer. Don't ever answer questions based on prior knowledge only",
            "idea": "Idea for an action using one of the tools in [TOOLS] to complete the task based on information in knowledge and past_events. If the task can be completed, always use the task_complete tool to provide ann answer.",
            "criticism": "If the task can be completed based on the previously gathered information summarized under knowledge and past_events, respond 'The task_complete tool must be used to provide an answer. This decision overrides reasoning and idea'. Otherwise respond 'N/A'",
